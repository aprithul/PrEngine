...
namespace PrEngine {
    ...
    public:
        ...
        Graphics* generate_graphics_quad(const std::string& texture_file_path, bool has_transparency);
        Graphics* generate_graphics_sprite(const std::string& texture_file_path);
